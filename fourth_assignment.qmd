...
!Har ikke kjørt denne chunken under! Chunken over fungerer bra?
...
ii. Last ned Data Structure Definition (DSD) for denne tabellen.
    ...
    i.  ***Skal vi ikke bruke dsd_gpd som vist på denne?***
...
full_pop_nuts3 <- nama_10r_3popgdp |>
  full_join(demo_r_pjanaggr3, nama_10r_3popgdp,
            #har lagt til nama_10r_3popgdp, den manglet vel?
            by = join_by(geo, time))
```
