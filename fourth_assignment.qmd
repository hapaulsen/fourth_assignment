...
```{r}
setdiff(nama_10r_3popgdp, demo_r_pjanaggr3)
```
...
```{r}
setdiff(demo_r_pjanaggr3, nama_10r_3popgdp)
```
...
```{r}
setdiff(full_pop_nuts3, nama_10r_3gdp)
```
...
```{r}
setdiff(nama_10r_3gdp, full_pop_nuts3)
```
